...
const BUTTON_CONFIG = {
  ...
  submit:   { icon: Send, style: "inline-flex items-center gap-2 px-5 py-2.5 bg-transparent hover:bg-green-800 border border-green-600 text-green-300 text-sm font-semibold rounded-lg transition-colors" },
  cancel:   { icon: X,    style: "inline-flex items-center gap-2 px-5 py-2.5 bg-transparent hover:bg-red-950/40 border border-red-900/60 text-red-400 text-sm font-semibold rounded-lg transition-colors ml-auto" },
